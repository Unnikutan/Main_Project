	  				...
	  				<div class="col-md-6">
	  					<div class="driver_table">
		  					...
		  					<table>
		  						...
		  						<tr>
		  							<td> Job </td>
		  							<td> <h3 class="text-left">Driver</h3></td>
		  						</tr>
		  						<tr>
		  							<td> Email </td>
				...
				?>
  				<div class="row mt-2">
					<div class="col-sm-12 text-center mb-4">
						<div style="font-size:20px; font-weight:bold;">Job : <span style="font-size: 30px;"> Driver</span></div> 
	  				...
	  				<div class="col-md-6">
	  					<div class="driver_table">
							<?php 
								$truckDr = "select truck_no from tbl_truck where driver_id = '$dr_id'";
								$res_truckDr = mysqli_query($conn,$truckDr);
							?>
		  					<table>
		  						<tr>
		  							<td> Truck assigned </td>
		  							<td> <input class="form-control text-center" style="margin-bottom: 0px;" value="<?php echo mysqli_num_rows($res_truckDr) ?>" disabled></td>
		  						</tr>
		  						<tr>
		  							<td> Truck Number </td>
		  							<td> 
										<div class="form-control border" style="margin-bottom: 0px; background-color:#e9ecef;"  disabled>
										<?php 
											while($row_truckDr = mysqli_fetch_array($res_truckDr)){
												echo $row_truckDr['truck_no']."<br>";
											}
										?> 
										</div>
									</td>
	  				...
	  				<div class="col-md-5">
	  					<div class="driver_table">
		  					<table>
								...
								?>
		  						<tr>
		  							<td> Route Assigned </td>
		  							<td> <input class="form-control user_table_td text-center" style="margin-bottom: 0px;" value="<?php echo mysqli_num_rows($res_routeDr) ?>" disabled></td>
		  						</tr>
		  						<tr>
		  							<td> Route Names </td>
		  							<td> 
									  <div class="form-control border" style="margin-bottom: 0px; background-color:#e9ecef;"  disabled>
										<?php 
											while($row_routeDr = mysqli_fetch_array($res_routeDr)){
												echo $row_routeDr['route_name']."<br>";
											}
										?> 
									</td>
		  						</tr>
